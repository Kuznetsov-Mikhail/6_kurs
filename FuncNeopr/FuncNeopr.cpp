...
// FuncNeopr.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CFuncNeoprApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CFuncNeoprApp

CFuncNeoprApp::CFuncNeoprApp()
{
...
// Единственный объект CFuncNeoprApp

CFuncNeoprApp theApp;


// Инициализация CFuncNeoprApp

BOOL CFuncNeoprApp::InitInstance()
{
