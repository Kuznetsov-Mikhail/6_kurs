...
// Signal_decoding.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSignaldecodingApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CSignaldecodingApp

CSignaldecodingApp::CSignaldecodingApp()
{
...
// Единственный объект CSignaldecodingApp

CSignaldecodingApp theApp;


// Инициализация CSignaldecodingApp

BOOL CSignaldecodingApp::InitInstance()
{
