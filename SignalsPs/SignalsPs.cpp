...
// SignalsPs.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSignalsPsApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CSignalsPsApp

CSignalsPsApp::CSignalsPsApp()
{
...
// Единственный объект CSignalsPsApp

CSignalsPsApp theApp;


// Инициализация CSignalsPsApp

BOOL CSignalsPsApp::InitInstance()
{
